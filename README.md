...
* **Configuración de Red en Servidor Ubuntu (SIEM):**
  ![Configuración de Red Ubuntu](images/00_config_red_ubuntu.png)
...
* **Configuración de Red en Windows 10 (Víctima):**
  ![Configuración de Red Windows](images/02_config_red_w10.png)
...
* **Prueba de Ping (Kali a Windows 10):**
  ![Conexión Ping](images/03_ping_conexion.png)
...
* **Administración Remota (SSH hacia Wazuh Manager):**
  ...
  ![Acceso SSH](images/04_acceso_ssh.png)
...
* **Verificación del Agente en el Dashboard de Wazuh:**
  ...
  ![Agente Activo en Wazuh](images/05_agente_activo.png)
...
![Escaneo Nmap](images/06_escaneo_nmap.png)
...
![Ataque Hydra](images/07_ataque_hydra.png)
...
* **Panel de Caza de Amenazas en Wazuh:**
  ...
  ![Histograma de Detección en Wazuh](images/08_dashboard_eventos.png)
